...
public class AntiqueVintageGlobeBlock extends RotatingBlock implements EntityBlock {
    public static final VoxelShape SHAPE = Shapes.or(box(4, 8, 4, 12, 16, 12), box(0, 0, 0, 16, 8, 16));

    public AntiqueVintageGlobeBlock(Properties props) {
        super(props, RotatingBlock.createShapeBuilder(SHAPE));
    }

    @Override
    public BlockEntity newBlockEntity(BlockPos pPos, BlockState pState) {
        return new AntiqueVintageGlobeBlockEntity(pPos, pState);
    }
