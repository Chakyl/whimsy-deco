...
public class VintageGlobeBlockEntity extends BlockEntity implements GeoBlockEntity {
    protected static final RawAnimation DEPLOY_ANIM = RawAnimation.begin().thenPlayAndHold("spin");

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public VintageGlobeBlockEntity(BlockPos pos, BlockState state) {
        super(WhimsyRegistry.BlockEntityRegistry.VINTAGE_GLOBE.get(), pos, state);
    }
